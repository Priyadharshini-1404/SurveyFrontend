...
export default function AirportSurveyScreen({ navigation }) {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.swiperContainer}>
        ...
        >
          ...
          <View style={styles.slide}>
            <Image
              source={require('../../../../assets/airport2.jpg')}
              style={styles.image}
              resizeMode="cover"
            />
          </View>
...
>
  <Text style={styles.buttonText}>Book Appointment</Text>
      ...
      Airport Surveys involve the precise measurement and mapping of runways, taxiways, terminals, and surrounding airspaces.
       These surveys are crucial for safe aircraft operations, expansion planning, and compliance with aviation standards.
       They help ensure that all airport infrastructure meets design and regulatory requirements.
      </Text>
