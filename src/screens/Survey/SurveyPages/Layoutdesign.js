...
export default function LayoutdesignSurveyScreen({ navigation }) {
  return (
    ...
    Layout Design and Stone Fixing Surveys establish permanent reference points (stone markers) on the site to indicate property limits and construction layouts. These stones act as benchmarks for future development and boundary identification, ensuring long-term accuracy and consistency in land records.
      </Text>
