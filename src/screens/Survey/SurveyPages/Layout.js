...
export default function LayoutSurveyScreen({ navigation }) {
  return (
    ...
    >
     ...
     A Layout Survey is performed to mark out plots, roads, and utility lines according to an approved master plan. It guides developers and builders in executing the layout accurately on-site. This survey is essential for housing projects, industrial layouts, and land development, ensuring that the design is implemented precisely as planned.
      </Text>
